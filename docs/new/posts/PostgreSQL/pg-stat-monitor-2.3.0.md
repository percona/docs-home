...
date: 2025-11-15
description: >
  `pg_stat_monitor` 2.3.0 has been released on November 15, 2025.
authors: [Andriciuc]
categories:
  - PostgreSQL
tags:
...
# `pg_stat_monitor` 2.3.0 has been released

<!-- more -->

[pg_stat_monitor](https://docs.percona.com/pg-stat-monitor/index.html){:target="_blank"} is the Query Performance Monitoring tool for PostgreSQL. Version 2.3.0 of `pg_stat_monitor` has been released on November 15, 2025.
