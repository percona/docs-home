...
- [Partial TLS certificates for MySQL monitoring](https://docs.percona.com/percona-monitoring-and-management/3/install-pmm-client/connect-database/mysql/mysql.html){:target="_blank"} enabling monitoring of Azure MySQL Flexible Server and Google Cloud SQL using only CA certificates
