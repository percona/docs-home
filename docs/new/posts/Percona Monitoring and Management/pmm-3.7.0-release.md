...
- [Percona Platform connectivity removed](https://docs.percona.com/percona-monitoring-and-management/3/release-notes/3.7.0.html#percona-platform-connectivity-removed){:target="_blank"} completing the Platform sunset — advisors and alert templates now ship directly with PMM
