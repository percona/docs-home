...
date: 2026-04-22
description: >
  Percona Distribution for MySQL 8.4.8 using Percona XtraDB Cluster has been released on Wednesday, April 22, 2026.
...
# Percona Distribution for MySQL 8.4.8 using Percona XtraDB Cluster has been released

<!-- more -->

[Percona Distribution for MySQL 8.4.8 using Percona XtraDB Cluster](https://docs.percona.com/percona-distribution-for-mysql/8.4/index.html){:target="_blank"} has been released on Wednesday, April 22, 202.
...
Learn more in Percona Distribution for MySQL 8.4.8 using Percona XtraDB Cluster [release notes](https://docs.percona.com/percona-distribution-for-mysql/8.4/release-notes-pxc-8.4.8.html){:target="_blank"}.
