...
date: 2026-07-23
description: >
  Percona XtraDB Cluster 8.0.46-38 has been released on Thursday, July 23, 2026.
...
# Percona XtraDB Cluster 8.0.46-38 has been released

<!-- more -->

[Percona XtraDB Cluster 8.0.46-38](https://docs.percona.com/percona-xtradb-cluster/8.0/){:target="_blank"} has been released on Thursday, July 23, 2026.
...
Percona XtraDB Cluster 8.0.46-38 is the final release of the Percona XtraDB Cluster 8.0 series. MySQL 8.0 and Percona Server for MySQL 8.0 have reached their End of Life (EOL).
...
Percona XtraDB Cluster 8.0.46-38 is based on Percona Server for MySQL and contains all improvements and bug fixes available in Percona Server for MySQL 8.0.46-38.
...
## Percona XtraDB Cluster 8.0.46-38
...
For a full list of the bug fixes, and to learn more, see the Percona XtraDB Cluster 8.0.46-38 [release notes](https://docs.percona.com/percona-xtradb-cluster/8.0/release-notes/8.0.46-38.html){:target="_blank"}.
