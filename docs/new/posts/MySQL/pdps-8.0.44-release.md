...
# Percona Distribution for MySQL 8.0.44 using Percona Server for MySQL has been released
...
Learn more in Percona Distribution for MySQL 8.0.44 using Percona Server for MySQL [release notes](https://docs.percona.com/percona-distribution-for-mysql/8.0/release-notes-ps-v8.0.44.html){:target="_blank"}.
