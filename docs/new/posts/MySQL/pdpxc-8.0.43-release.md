...
date: 2025-09-18
description: >
  Percona Distribution for MySQL 8.0.43 using Percona XtraDB Cluster has been released on Thursday, September 18, 2025.
...
[Percona Distribution for MySQL 8.0.43 using Percona XtraDB Cluster](https://docs.percona.com/percona-distribution-for-mysql/8.0/index.html){:target="_blank"} has been released on Thursday, September 18, 2025.
