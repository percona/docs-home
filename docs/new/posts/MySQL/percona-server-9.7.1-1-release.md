...
date: 2026-08-05
description: >
  Percona Server for MySQL 9.7.1-1 has been released on Wednesday, August 5, 2026.
...
[Percona Server for MySQL 9.7.1-1](https://docs.percona.com/percona-server/9.7/index.html){:target="_blank"} has been released on Wednesday, August 5, 2026.

Try it out using the [Quickstart guide](https://docs.percona.com/percona-server/9.7/quickstart-overview.html){:target="_blank"}.

Percona Server for MySQL 9.7.0-1 was not released. Percona Server for MySQL 9.7.1-1 is the first build in the 9.7 series and includes enhancements and bug fixes from MySQL 9.7.0 and MySQL 9.7.1.
...
* Suppresses nested general and status records in Audit Log Filter output when `audit_log_filter.event_mode=REDUCED` is enabled.

* Removes `format=OLD` and makes JSONL the default Audit Log Filter output format.

* Optimizes performance for `mem_root_deque`.

## MySQL 9.7

Improvements and bug fixes introduced by Oracle for MySQL 9.7 and included in Percona Server for MySQL are the following:
...
Find the complete lists of bug fixes and changes in the [MySQL 9.7.0 release notes :octicons-link-external-16:](https://dev.mysql.com/doc/relnotes/mysql/9.7/en/news-9-7-0.html){:target="_blank"} and [MySQL 9.7.1 release notes :octicons-link-external-16:](https://dev.mysql.com/doc/relnotes/mysql/9.7/en/news-9-7-1.html){:target="_blank"}.

## Security updates

This release addresses the following security vulnerabilities:

* [CVE-2026-46850](https://www.cve.org/CVERecord?id=CVE-2026-46850){:target="_blank"}: A vulnerability in MySQL Shell (Shell for Visual Studio Code) allows a low-privileged attacker with network access via HTTP to compromise MySQL Shell, with potential scope change impact on additional products (CVSS 3.1 Base Score 9.9).
...
* [CVE-2026-46862](https://www.cve.org/CVERecord?id=CVE-2026-46862){:target="_blank"}: A vulnerability in MySQL Router allows an unauthenticated attacker with network access via TLS to cause MySQL Router to stop responding or exit unexpectedly in a repeatable manner (CVSS 3.1 Base Score 7.5).

* [CVE-2026-46863](https://www.cve.org/CVERecord?id=CVE-2026-46863){:target="_blank"}: A vulnerability in MySQL Server connection handling allows an unauthenticated attacker with network access via multiple protocols to cause the server to stop responding or exit unexpectedly in a repeatable manner (CVSS 3.1 Base Score 7.5).
...
* [CVE-2026-46870](https://www.cve.org/CVERecord?id=CVE-2026-46870){:target="_blank"}: A vulnerability in MySQL Shell (Shell for Visual Studio Code) allows a low-privileged attacker with network access to compromise MySQL Shell, with potential scope change impact (CVSS 3.1 Base Score 8.5).

* [CVE-2026-46871](https://www.cve.org/CVERecord?id=CVE-2026-46871){:target="_blank"}: A vulnerability in MySQL Shell (Shell for Visual Studio Code) allows a low-privileged attacker with network access via multiple protocols to access critical data (CVSS 3.1 Base Score 6.5).
...
* For Percona Server for MySQL 9.7.1-1, Debian and Ubuntu (APT) packaging has been reorganized to align more closely with upstream MySQL. Several packages have been split into separate components, which may affect upgrades and dependency resolution compared with earlier Percona Server releases.
