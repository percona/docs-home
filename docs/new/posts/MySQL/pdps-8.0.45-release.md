...
date: 2026-02-17
description: >
  Percona Distribution for MySQL 8.0.45 using Percona Server for MySQL has been released on February 17, 2026.
...
# Percona Distribution for MySQL 8.0.45 using Percona Server for MySQL has been released

<!-- more -->

[Percona Distribution for MySQL 8.0.45 using Percona Server for MySQL](https://docs.percona.com/percona-distribution-for-mysql/8.0/index.html){:target="_blank"} has been released on February 17, 2026.
...
Learn more in Percona Distribution for MySQL 8.0.45 using Percona Server for MySQL [release notes](https://docs.percona.com/percona-distribution-for-mysql/8.0/release-notes-ps-v8.0.45.html){:target="_blank"}.
